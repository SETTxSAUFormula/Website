...
const vehicleHistory: Record<Language, VehicleDetail[]> = {
  tr: [
    ...
    { year: '2010', name: 'SETTAR', result: 'Urban Concept · 7.lik', category: 'Shell Eco-marathon 2010 · Urban Concept', image: '/vehicles/settar.webp', technology: 'Hidrojen yakıt hücresi', competition: 'Shell Eco-marathon Europe 2010 · Urban Concept', description: 'SETTAR, depolanan hidrojeni yakıt hücresinde elektrik enerjisine dönüştürerek elektrik motorunu besleyen şehir konseptli bir verimlilik aracıydı. Shell Eco-marathon Europe 2010’da Urban Concept kategorisinde yedinci oldu.', sourceUrl: 'https://www.shell.com.tr/media/_jcr_content/root/main/section_1073788075/promo_copy_164329186_1100663819/links/item0.stream/1721053140325/7687b5722a02d2a72f92e2db29f9515d96c4b06f/2011-pr-turkey.pdf' },
    ...
    { year: '2024–25', name: 'ADA-01', result: 'Project Work · 2.lik', category: 'Formula Student Russia · Project Work', image: '/vehicles/ada-01.webp', technology: 'İçten yanmalı Formula Student', competition: 'Formula Student Russia · Project Work', description: 'ADA-01, SAUFormula’nın ilk Formula Student otomobili ve takımın yarış aracı geliştirme altyapısının başlangıcı oldu. İçten yanmalı sınıfta geliştirilen projede hafif gövde yaklaşımı ve paslanmaz çelik şasi öne çıktı; ekip, Formula Student Russia’nın Project Work kategorisinde ikincilik elde etti.', sourceUrl: 'https://uticdergisi.sakarya.edu.tr/hayallerin-hizla-bulustugu-nokta-sau-formula/', scale: 0.78 },
  ...
  en: [
    ...
    { year: '2010', name: 'SETTAR', result: 'Urban Concept · 7th place', category: 'Shell Eco-marathon', image: '/vehicles/settar.webp', technology: 'Hydrogen fuel cell', competition: 'Shell Eco-marathon Europe 2010', description: 'SETTAR was an urban-concept efficiency car whose fuel cell converted stored hydrogen into electricity for its motor. At Shell Eco-marathon Europe 2010, it finished seventh in the Urban Concept category.', sourceUrl: 'https://www.shell.com.tr/media/_jcr_content/root/main/section_1073788075/promo_copy_164329186_1100663819/links/item0.stream/1721053140325/7687b5722a02d2a72f92e2db29f9515d96c4b06f/2011-pr-turkey.pdf' },
...
const pageCopy = {
  tr: {
    eyebrow: '2007’den bugüne · Mühendislik mirası', title: 'Araçlarımız', description: 'Hidrojen ve güneş enerjili verimlilik araçlarından Formula Student otomobillerine uzanan ortak mühendislik hafızamız.', aside: '19 yıllık birikim',
  ...
  en: {
    eyebrow: 'Engineering heritage · Since 2007', title: 'Our Cars', description: 'Our shared engineering memory, from hydrogen and solar-efficiency vehicles to Formula Student race cars.', aside: '19 years of experience',
      ...
      <section className="border-y border-white/10 bg-[#071b14] px-5 py-14 lg:px-10 lg:py-18">
        <div className="mx-auto grid max-w-[1650px] gap-10 lg:grid-cols-[1.38fr_0.62fr] lg:items-center">
          <div className="grid gap-2 overflow-hidden border border-white/12 bg-[#071b14] sm:grid-cols-2">
            {[
              ...
              <figure key={src} className="relative aspect-square overflow-hidden bg-[#061811]">
                ...
                <figcaption className="absolute bottom-4 left-4 border border-white/20 bg-ink/55 px-3 py-2 text-xs font-bold uppercase tracking-[0.18em] text-white backdrop-blur-md">
                  {label}
                </figcaption>
              </figure>
            ))}
          ...
          <div className="lg:pl-4">
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-racing-green">{copy.current}</p>
            ...
            <p className="mt-4 text-base leading-7 text-white/65">{copy.currentNote}</p>
      ...
      <section className="bg-ink px-5 py-16 text-white lg:px-10 lg:py-20">
        <div className="mx-auto max-w-[1650px] border-t border-white/15 pt-8">
          <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.22em] text-racing-green">{copy.achievements}</p>
              <h2 className="mt-3 font-heading text-4xl font-black uppercase sm:text-5xl">{copy.heritage}</h2>
            </div>
            <p className="max-w-xl text-sm leading-7 text-white/65">{copy.heritageText}</p>
          </div>
