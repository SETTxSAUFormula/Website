  ...
  return (
    <section className="relative isolate overflow-hidden bg-ink px-5 py-9 text-white sm:py-12 lg:px-10 lg:py-14">
      ...
      <div className="mx-auto grid max-w-[1500px] gap-5 sm:gap-8 lg:grid-cols-[1fr_0.55fr] lg:items-end">
        <div>
          <nav aria-label={language === 'en' ? 'Breadcrumb' : 'Sayfa işaret yolu'} className="mb-4 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.16em] text-white/65 sm:mb-6 sm:text-xs sm:tracking-[0.18em]">
          ...
          <p className="text-xs font-bold uppercase tracking-[0.24em] text-racing-green">{eyebrow}</p>
