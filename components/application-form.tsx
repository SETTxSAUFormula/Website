...
const copy = {
  tr: {
    ...
    consent: 'Başvuru bilgilerimin başvuru sürecinin yürütülmesi, değerlendirilmesi ve benimle iletişim kurulması amacıyla güvenli biçimde kaydedilip işlenmesini kabul ediyorum.', privacy: 'Gizlilik Politikası',
    security: 'Güvenli başvuru', note: 'Başvurunuz güvenli biçimde kaydedilir ve değerlendirme için SAUFormula ekibine e-posta bildirimi gönderilir.', send: 'Başvuruyu gönder', sending: 'Gönderiliyor', success: 'Başvurunuz başarıyla gönderildi. Ekibimiz değerlendirme sonrasında sizinle iletişime geçecektir.', error: 'Başvuru gönderilemedi. Lütfen bilgilerinizi kontrol edip yeniden deneyin veya info@sauformula.org adresine yazın.', verify: 'Göndermeden önce güvenlik doğrulamasını tamamlayın.',
  },
  en: {
    ...
    consent: 'I consent to my application data being securely stored and processed to manage and evaluate my application and contact me.', privacy: 'Privacy Policy',
    security: 'Secure application', note: 'Your application is securely recorded and the SAUFormula team receives an email notification for evaluation.', send: 'Submit application', sending: 'Submitting', success: 'Your application was submitted successfully. Our team will contact you after reviewing it.', error: 'We could not submit your application. Please review your details and try again, or email info@sauformula.org.', verify: 'Please complete the security verification before submitting.',
  },
