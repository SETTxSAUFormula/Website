...
const sponsorTiers: Array<{
  ...
  },
  {
    ...
    sponsors: [
      ...
      { name: 'Altium', src: '/sponsors/2026/altium.svg', website: 'https://www.altium.com/', scale: 1.7 },
  ...
  },
  {
    ...
    sponsors: [
      ...
      { name: 'Isılsan', src: '/sponsors/2026/isilsan.png', website: 'https://isilsanmakina.com.tr/', scale: 1.15 },
